...
public class DemoApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = userRepository.save(new User("admin", "admin@gmail.com", "admin", "admin", "admin", true, r1));
        User user2 = userRepository.save(new User("user1", "user1@gmail.com", "user1", "user1", "user1", true, r2));
